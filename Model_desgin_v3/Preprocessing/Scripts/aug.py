...
FOLDER      = r"./"
REAL_INPUT  = os.path.join(FOLDER, "real_part_1_rows_1_to_30000.csv")
FAKE_INPUT  = os.path.join(FOLDER, "fake_part_1_rows_1_to_30000.csv")
REAL_OUTPUT = os.path.join(FOLDER, "real_120k_lfm.csv")
FAKE_OUTPUT = os.path.join(FOLDER, "fake_120k_lfm.csv")
