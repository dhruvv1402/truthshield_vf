...
FOLDER      = r"./"
REAL_INPUT  = os.path.join(FOLDER, "real_part_4_rows_90001_to_120000.csv")
FAKE_INPUT  = os.path.join(FOLDER, "fake_part_4_rows_90001_to_120000.csv")
REAL_OUTPUT = os.path.join(FOLDER, "real_120k_lfm_part_4.csv")
FAKE_OUTPUT = os.path.join(FOLDER, "fake_120k_lfm_part_4.csv")
